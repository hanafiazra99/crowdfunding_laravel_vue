            ...
            <v-card-text>
                <v-simple-table dense>
                    <tbody>
                        ...
                        <tr>
                            <td> <v-icon>mdi-hand-heart</v-icon>Dana Terkumpul</td>
                            <td class="blue--text">{{campaign.collected.toLocaleString('id-ID')}}</td>
                        </tr>
                        <tr>
                            <td> <v-icon>mdi-cash</v-icon>Dana Dibutuhkan</td>
                            <td class="blue--text">{{campaign.required.toLocaleString('id-ID')}}</td>
                        </tr>
                    </tbody>
                </v-simple-table>
                Description: <br>
